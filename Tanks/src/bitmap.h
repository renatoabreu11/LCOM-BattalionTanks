 ...
 * @{
 * Code developed by the MIEIC student, Henrique Ferrolho, based on a
 * thread on fedoraforum.org, and modified by us in order to use in our project
 ...
 */
void drawBitmap(Bitmap* bitmap, int x, int y, Alignment alignment, int mouse_flag);

/**
 * @brief rotate the bitmap passed as argument n*90 degrees
 *
 * @param bitmap bitmap to be rotated
 * @param  4 is a 180 degrees rotation
 *	       -2 is a 90 degrees rotation
 *         2 is a -90 degrees rotation
 */
